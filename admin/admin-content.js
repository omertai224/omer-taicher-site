    ...
    : filtered.map(p => {
      ...
      <div style="background:var(--cream);border:1px solid var(--border);border-radius:12px;padding:14px 18px;margin-bottom:10px;display:flex;align-items:center;gap:14px;">
        ...
        <div style="display:flex;gap:8px;flex-shrink:0">
          ...
          <button onclick="window.open(location.origin+'/blog/post.html?id=${p.id}','_blank')" style="background:var(--cream);color:var(--text-mid);border:1px solid var(--border);padding:7px 14px;border-radius:20px;font-size:0.78rem;font-weight:700;cursor:pointer;font-family:inherit">צפה</button>
    ...
    <div class="field">
      <div style="display:flex;align-items:flex-end;gap:16px;flex-wrap:wrap">
        ...
        <div style="display:flex;gap:8px;padding-bottom:2px;flex-wrap:wrap">
          ${blogEditingId ? `<button onclick="window.open(location.origin+'/blog/post.html?id=${blogEditingId}','_blank')" style="background:var(--navy-light);color:var(--navy);border:none;padding:8px 16px;border-radius:20px;font-size:0.82rem;font-weight:700;cursor:pointer;font-family:inherit">צפה</button>` : ''}
