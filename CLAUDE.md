...
0. **ניקוי ופיצול** — פרמוט HTML, חילוץ ל-slides.json, שינוי שמות תמונות, קישור ל-shared → **דחיפה**
1. **עומר מתאר תמונות** — עובר תמונה-תמונה, מגדיר מה בכל צעד → **עדכון slides.json + דחיפה**
2. **שקפים מיוחדים** — פתיחה, סרטון, הורדה, מעבר, סיום (HTML ב-slides.json) → **דחיפה**
3. **slideMap** — הגדרת שקפים מיוחדים (inline script ב-index.html) → **דחיפה**
4. **בדיקת תקינות** — צ'קליסט, כל השקפים עובדים → **דחיפה**
5. **הכנסה למאגר ולמכירה** (ראו שלב מפורט למטה) → **דחיפה**
