...
- **כלל ברזל: בתחילת כל סשן, לעדכן את `editor/github.js` שורה 7 (`GH.branch`) לבראנצ' העבודה של הסשן הנוכחי!** ככה עומר שומר מהעורך ישירות לבראנצ' הנכון. לדחוף מיד אחרי השינוי.
