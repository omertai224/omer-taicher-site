...
- **בראנצ' שמירה נשלט מ-localStorage** (`editor_branch`). בעורך יש badge בפינה השמאלית תחתונה שמראה לאיזה בראנצ' שומרים. לחיצה עליו מאפשרת לשנות.
- **כלל ברזל: בתחילת כל סשן, להודיע לעומר לשנות בראנצ' בעורך!** עומר לוחץ על ה-badge בפינה, מקליד את שם הבראנצ' החדש, וזהו. אם עומר לא מחובר לעורך, אפשר גם לעדכן ישירות את `editor/github.js` שורה 7 (`GH.branch`).
