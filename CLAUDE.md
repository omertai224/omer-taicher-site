...
- **זיהוי קליק ימני / לחיצה כפולה / לחיצות מרובות:** בניתוח התמונות, אם הפעולה דורשת **קליק ימני**, **לחיצה כפולה (double-click)**, או **לחיצות מרובות** (כמו כוכבים בג'ימייל) — חובה לסמן ב-slide-map ולהוסיף הבהרה בבועת הטקסט. **חשוב: "כאן בהדרכה" תמיד בשורה נפרדת!** הפורמט: `<br><span style="font-size:13px;"><span style="color:#f6a67e;font-weight:700;">במחשב שלכם:</span> [תיאור הפעולה].&nbsp;</span><br><span style="font-size:13px;"><span style="color:#f6a67e;font-weight:700;">כאן בהדרכה:</span> לחצו פעם אחת על הסימון הכתום.</span>`. בהדרכה אין קליק ימני, אין לחיצה כפולה, ואין לחיצות מרובות — רק לחיצה רגילה אחת!
...
- **`right-click`** — קליק ימני עם העכבר. box רגיל + הבהרה (שורה 1: "במחשב שלכם: קליק ימני", שורה 2: "כאן בהדרכה: לחצו פעם אחת על הסימון הכתום")
- **`double-click`** — לחיצה כפולה (למשל פתיחת קובץ התקנה). box רגיל + הבהרה (שורה 1: "במחשב שלכם: לחיצה כפולה", שורה 2: "כאן בהדרכה: לחצו פעם אחת על הסימון הכתום")
