/* Windows NightLight Tutorial - Dynamic slide builder */
...
function initApp() {
  ...
  fetch('slides.json')
    ...
    .catch(function(err) { console.error('NightLight ERROR:', err); });
}
...
function getPersonalName() {
  ...
  if (name) { localStorage.setItem('nightlight_user_display', name); return name; }
  return localStorage.getItem('nightlight_user_display') || '';
}
