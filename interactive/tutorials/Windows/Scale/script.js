...
function initApp() {
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Mobile|mobile|CriOS/i.test(ua)) {
    enhanceMobileBlock('scale'); return;
  }
  fetch('slides.json')
    ...
    .catch(function(err) { console.error('Scale ERROR:', err); });
}
...
function getPersonalName() {
  ...
  if (name) { localStorage.setItem('scale_user_display', name); return name; }
  return localStorage.getItem('scale_user_display') || '';
}
