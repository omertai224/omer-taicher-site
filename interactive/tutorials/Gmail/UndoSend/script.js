...
function initApp() {
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Mobile|mobile|CriOS/i.test(ua)) {
    enhanceMobileBlock('undosend'); return;
  }
  fetch('slides.json')
    ...
    .catch(function(err) { console.error('UndoSend ERROR:', err); });
}
...
function getPersonalName() {
  ...
  if (name) { localStorage.setItem('undosend_user_display', name); return name; }
  return localStorage.getItem('undosend_user_display') || '';
}
