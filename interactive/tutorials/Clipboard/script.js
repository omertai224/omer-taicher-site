/* Clipboard Tutorial - Dynamic + Everything features */

var slideIndex = 1;
var slidesData = null;

/* ── slideMap: שקפים מיוחדים (0-based) ── */
/* יתעדכן אחרי שנדע את המבנה הסופי */
var slideMap = {
  0:  { icon: 'home', title: 'פתיחה' }
  /* finish slide will be set dynamically after loading */
};
...
function showSlides(n) {
  ...
  if (n == slides.length) {
    next.src = '../../shared/images/right-disabled.png';
    next.style.cursor = 'default';
  } else {
    next.src = '../../shared/images/right.png';
    next.style.cursor = 'pointer';
  }
  if (n == 1) {
    prev.src = '../../shared/images/left-disabled.png';
    prev.style.cursor = 'default';
  } else {
    prev.src = '../../shared/images/left.png';
...
document.addEventListener('keydown', function(e) {
  ...
  else if (e.key === 'Escape' && magnifierActive) toggleMagnifier();
});
