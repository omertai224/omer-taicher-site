...
var slideMap = {
  ...
  1: { icon: 'monitor', title: 'מה זה בכלל' },
  2: { icon: 'monitor', title: 'הסדר הנכון' },
  3: { icon: 'monitor', title: 'חצים' },
  4: { icon: 'monitor', title: 'פס הניווט' },
  5: { icon: 'search',  title: 'זכוכית מגדלת' },
  6: { icon: 'monitor', title: 'הקראה בקול' },
  7: { icon: 'warning', title: 'מינוס, לא X' },
  8: { icon: 'finish',  title: 'סיום' }
};
