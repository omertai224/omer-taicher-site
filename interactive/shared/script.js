...
function buildHowToSlide1() {
  ...
  return '<div class="ht-wrap">'
    ...
    + '<div class="ht-card">'
    + '<div class="ht-icon" style="background:transparent;"><div style="width:55%;height:50%;border:4px solid #ff7c2a;border-radius:10px;box-shadow:0 0 0 2px rgba(255,124,42,0.4),0 0 16px rgba(255,124,42,0.6);animation:box-pulse 1.8s ease-in-out infinite;"></div></div>'
