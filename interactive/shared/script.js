...
var specialIcons = {
  ...
  book: '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 4.5A2.5 2.5 0 016.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15z"/></svg>',
...
/* ── Right-click blocker: friendly message near cursor ── */
(function() {
  var overlay = null;
  var timeout = null;

  function showClickMessage(e, text) {
    ...
    overlay.innerHTML = '<div style="display:flex;align-items:center;gap:10px;justify-content:center;">'
      ...
      + '<span style="color:white;font-size:17px;font-weight:800;">' + text + '</span></div>';
