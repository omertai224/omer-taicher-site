...
function buildPanel() {
  ...
  $('panel').innerHTML = ''
    ...
    + '<div style="margin-top:6px;display:flex;gap:5px;flex-wrap:wrap;justify-content:flex-end;"><span class="orange-btn" onclick="toggleAnim(\'scrollDown\')" id="btnScrollDown" title="גלילה למטה" style="color:#f6a67e;border-color:#f6a67e55;">⬇ גלילה</span><span class="orange-btn" onclick="toggleAnim(\'rightClick\')" id="btnRightClick" title="קליק ימני" style="color:#f6a67e;border-color:#f6a67e55;">🖱 ימני</span><span class="orange-btn" onclick="toggleContinueBtn()" id="btnContinue" title="כפתור המשך" style="color:#5b8fa8;border-color:#5b8fa855;">▶ המשך</span></div>'
    + '<div style="margin-top:4px;display:flex;gap:5px;flex-wrap:wrap;justify-content:flex-end;"><span class="orange-btn" onclick="toggleAnim(\'doubleClick\')" id="btnDoubleClick" title="לחיצה כפולה" style="color:#f6a67e;border-color:#f6a67e55;">⏸ כפולה</span><span class="orange-btn" onclick="toggleAnim(\'dragDrop\')" id="btnDragDrop" title="גרירה" style="color:#f6a67e;border-color:#f6a67e55;">↕ גרירה</span><span class="orange-btn" onclick="toggleAnim(\'typing\')" id="btnTyping" title="הקלדה" style="color:#f6a67e;border-color:#f6a67e55;">⌨ הקלדה</span></div>'
