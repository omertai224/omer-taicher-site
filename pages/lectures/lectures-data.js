var lecturesData = [
  {
    ...
    chapters: [
      { time: "18:54", label: "פתיחה" },
      { time: "22:51", label: "חשוד ראשון: ספק כוח" },
      { time: "24:18", label: "חשוד שני: מסך" },
      { time: "25:39", label: "חשוד שלישי: RAM" },
      { time: "28:14", label: "חשוד רביעי: לוח אם" },
      { time: "29:33", label: "טיפ ללפטופ שלא מתעורר משינה עמוקה" },
      { time: "30:25", label: "מחשב איטי, למה ומה עושים?" },
      { time: "32:33", label: "HDD לעומת SSD, ההבדל שמשנה הכל" },
      { time: "36:00", label: "טמפרטורה וניקוי המחשב" }
    ],
    cta: null
  },
  {
